        ...
        <section className='about' id="about">
            <div>
                ...
                <div className='extra_info'>
                    ...
                    <div className="info_container two">
                        <motion.h3 className='subsubsection_title two' variants={soloVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>Extracurricular Activities</motion.h3>
                        <motion.div className='info_inner' variants={soloVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                            <div className="content jobs">
                                <ul>
                                    {props.about.extracurriculars.map((activity, index) => (
